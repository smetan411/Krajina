...
public class OstrovObdelnik extends PlayerCommandExecutor {
    ...
    public boolean onCommandPlayer(Player player, World world, Location playerLocation, String[] args) {
        ...
        int hloubka = 25;
        int sirkaOstrova = hloubka * 2;
        int delkaOstrova = sirkaOstrova;

        for (int i = 0; i < hloubka; i++) {
            postavDesku(world, playerLocation, sirkaOstrova + 2 * i, delkaOstrova + 2 * i);
    ...
    private void postavDesku(World world, Location playerLocation, int sirkaOstrova, int delkaOstrova) {
