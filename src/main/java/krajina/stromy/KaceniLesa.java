...
public class KaceniLesa extends PlayerCommandExecutor {
    ...
    public boolean onCommandPlayer(Player player, World world, Location playerLocation, String[] args) {
        ...
        for (int x = mistoX - 20; x < mistoX + 21; x++) {
            for (int z = mistoZ - 20; z < mistoZ + 21; z++) {
    ...
    public KaceniLesa(World world) {
        this.world = world;
    }

    private final EnumSet<Material> TYPY_STROMU = EnumSet.of(Material.JUNGLE_LOG, Material.ACACIA_LOG,
